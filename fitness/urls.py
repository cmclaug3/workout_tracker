...
from fitness.views import home, new_cardio_interval, new_cardio_repetition, new_cardio_scheme, NewWorkoutView, single_workout, ResistanceSchemeView, ResistanceSetView
